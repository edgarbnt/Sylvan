...
# Usage :  bash voir_salamandre_cerveau.sh [omega] [checkpoint]
#   bash voir_salamandre_cerveau.sh 0                         # marche droite, dernier best
#   bash voir_salamandre_cerveau.sh 0.6                       # virage
#   bash voir_salamandre_cerveau.sh 0 data/checkpoints/sal_fwd/policy_best.pt
