...
# Workflow : ouvre la carte dans un AUTRE terminal (`bash voir_archi.sh`), puis lance ce script ici.
...
echo "════════════════════════════════════════════════════════════════════"
echo " Archi-HUD LIVE"
echo "  1) Ouvre la carte dans un AUTRE terminal :  bash voir_archi.sh"
