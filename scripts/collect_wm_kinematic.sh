...
# Body constants (MUST match runtime): kin_speed=0.5 (m/s per vx), kin_turn=1.5 (rad/s per omega).
...
export SYLVAN_KINEMATIC=1 SYLVAN_KIN_SPEED=${KIN_SPEED:-0.5} SYLVAN_KIN_TURN=${KIN_TURN:-1.5}
