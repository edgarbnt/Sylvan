...
#
# Usage : bash run_forage_memory.sh [eat_radius=1.0] [horizon=160] [episodes=12]
#           MEM=on  bash run_forage_memory.sh        → mémoire ON,  cone 180°
#           MEM=off bash run_forage_memory.sh        → mémoire OFF, cone 180°
#           MEM=on  SYLVAN_OCCLUDE_FOV_DEG=360 bash run_forage_memory.sh  → mémoire ON, 360° (non-régression)
set +e
