...
# Usage: bash scripts/diag_nav_ab.sh [dist=4.0] [eps_per_angle=2] [max_steps=900]
set +e
DIST=${1:-4.0}
NEP=${2:-2}
MS=${3:-900}
...
WM=${WM:-data/checkpoints/wm_command_hex_v2/wm_best.pt}   # override: WM=... bash scripts/diag_nav_ab.sh ...
echo "WM=$WM"
