...
SYLVAN_FOOD_COUNT=${SYLVAN_FOOD_COUNT:-3} SYLVAN_WATER_COUNT=${SYLVAN_WATER_COUNT:-3} SYLVAN_ENERGY_DRAIN=0.05 SYLVAN_THIRST_DRAIN=0.05 \
SYLVAN_INIT_ENERGY=70 SYLVAN_INIT_THIRST=70 \
SYLVAN_FOOD_MIN_RADIUS=${SYLVAN_FOOD_MIN_RADIUS:-2.0} SYLVAN_FOOD_SPAWN_RADIUS=${SYLVAN_FOOD_SPAWN_RADIUS:-6.0} SYLVAN_WATER_MIN_RADIUS=${SYLVAN_WATER_MIN_RADIUS:-2.0} SYLVAN_WATER_SPAWN_RADIUS=${SYLVAN_WATER_SPAWN_RADIUS:-6.0} \
